...
const RescuedInsert = () => {
  ...
  const handleSubmit = (e) => {
    ...
    let adminUrl = `http://localhost:3002/rescued_animal_insert/${formData.age}/${formData.breed}/${formData.weight}/${formData.rate}/${formData.type}/${formData.coming_date}/${formData.release_date}/${formData.cabin_no}/${formData.health_record_id}/${formData.customer_id}`;
    fetch(adminUrl);
  }; //:age/:breed/:weight/:rate/:type/:coming_date/:release_date/:cabin_no/:health_record_id/:customer_id
